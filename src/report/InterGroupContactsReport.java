...
/**
 * This report counts the number of contacts according to group affiliation.
 * The report contains the number of contacts between groups based on the frequency.
 *
 * @author Johannes Seiler, Nadja Schricker
 */
public class InterGroupContactsReport extends Report implements ConnectionListener {

	protected HashMap<String, Integer> groupContacts;

	public InterGroupContactsReport() {
		init();
	}
