...
/**
 * This class models the movement of students in an university.
 * The node starts at a certain start point and walks the shortest path
 * to the first random choosen room in the university (e.g. a lecture room or the library)
 * Similarly, it walks to the cafeteria at lunch time. After a certain number of completed
 * lectures/rooms, it will walk back to its start point (=home)
 *
 * @author Johannes Seiler, Nadja Schricker
 *
 */

public class UniMovement extends MapBasedMovement implements
        SwitchableMovement {
     ...
     * @param proto
     */
    public UniMovement(UniMovement proto) {
        super(proto);
